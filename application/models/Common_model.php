...
class Common_model extends CI_Model {
	...
	public function delete1($table,$section_id,$device_id)
	{
		//print_r("<pre/>");
		//print_r($device_id);
		//die;
	    ...
	    $this->db->delete('cell_item_data');
	    return;
	}
	public function delete2($table,$section_id,$device_id)
	{
	    
        $this->db->where_in('text_data.section_id',$section_id); 
	    $this->db->where('text_data.device_id',$device_id);
	    $this->db->delete('text_data');
...
public function getAll1($table,$cid)
	...
	function jointhreetable($table, $field_first, $table1, $field_second,$table2,$field_third,$value,$where='',$order_id, $order_arg,$field) {
		...
		function jointhreetableleft($table, $field_first, $table1, $field_second,$table2,$field_third,$value,$where='',$order_id, $order_arg,$field) {
