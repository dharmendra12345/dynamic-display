...
<div style="float:right">  
  <a href="<?php echo base_url(); ?>administrator/addtext" class="small-tile green-back">
  <img width="32" src="<?php echo base_url(); ?>assets_admin/images/icons/tick.png" class="hide-sm pull-right">
  <h3 class="h3-tile add_title">Add a new text item</h3></a>	
</div>  
      <div class="warper container-fluid">     
	  <div class="page-header"><h1>Text item</h1></div>	
	  ...
	  if(!empty($textitem)){	
	  foreach($textitem as $val) { ?>     
	  <tr class="odd gradeX">                
	  <td><?php echo $val->name; ?></td>     
	   		
	 <?php /*?> <td><?php echo $val->text_file_name; ?></td>	<?php */?>	
	  <td><?php echo $val->text_file_download_url; ?></td>		
	  <td><?php echo $val->text_color; ?></td>		

	  <td><?php echo $val->downloadable; ?></td>
	  		
   
	  <td>		
	  <a class=""  href="<?php echo base_url().'administrator/edit-text/'.$val->text_item_id; ?>">Edit</a>	
	  <a class=""  href="<?php echo base_url().'administrator/viewtext/'.$val->text_item_id; ?>">View</a>  
	<?php /*?>  <a class=""  href="<?php echo base_url().'administrator/disable-tournament/'.$val->id; ?>"><?php if($val->status == 1){echo 'Active';}else{echo 'deactive';} ?></a><?php */?>	
	  <a href="<?php echo base_url(); ?>administrator/delete-text/<?php echo $val->text_item_id; ?>" onclick="return confirm('Are you sure delete this  ?')">Delete</a>	 </td>   
