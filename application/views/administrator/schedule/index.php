...
<div style="float:right">  
  <a href="<?php echo base_url(); ?>administrator/addschedule" class="small-tile green-back">
  <img width="32" src="<?php echo base_url(); ?>assets_admin/images/icons/tick.png" class="hide-sm pull-right">
  <h3 class="h3-tile add_title">Add a new Schedule</h3></a>	
</div>  
	  ...
	  <td><?php echo $val->schedule_start_time; ?></td>		
	  <td><?php echo $val->schedule_end_time;  ?></td> 
      <td><?php echo $val->repeat_schedule;  ?></td>
  ...
  <?php /*?>    <td><?php echo date('h:i:s', strtotime($val->create_date_time)); ?></td>	<?php */?>
	  ...
	  <td>		
	  <a class=""  href="<?php echo base_url().'administrator/edit-schedule/'.$val->schedule_id; ?>">Edit</a>	
	  <a class=""  href="<?php echo base_url().'administrator/viewschedule/'.$val->schedule_id; ?>">View</a>  
	<?php /*?>  <a class=""  href="<?php echo base_url().'administrator/disable-tournament/'.$val->id; ?>"><?php if($val->status == 1){echo 'Active';}else{echo 'deactive';} ?></a><?php */?>	
	  <a href="<?php echo base_url(); ?>administrator/delete-schedule/<?php echo $val->schedule_id; ?>" onclick="return confirm('Are you sure delete this Tournament?')">Delete</a>	 </td>   
