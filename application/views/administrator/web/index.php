...
<div style="float:right">  
  <a href="<?php echo base_url(); ?>administrator/addweb" class="small-tile green-back">
  <img width="32" src="<?php echo base_url(); ?>assets_admin/images/icons/tick.png" class="hide-sm pull-right">
  <h3 class="h3-tile add_title">Add a new Web item</h3></a>	
</div>  
      <div class="warper container-fluid">     
	  <div class="page-header"><h1>Web item</h1></div>	
	  ...
	  <td><?php echo $val->	web_url; ?></td>		
			
 
	    
	  <td>		
	  <a class=""  href="<?php echo base_url().'administrator/edit-web/'.$val->web_item_id; ?>">Edit</a>	
	  <a class=""  href="<?php echo base_url().'administrator/viewweb/'.$val->web_item_id; ?>">View</a>  
	<?php /*?>  <a class=""  href="<?php echo base_url().'administrator/disable-tournament/'.$val->id; ?>"><?php if($val->status == 1){echo 'Active';}else{echo 'deactive';} ?></a><?php */?>	
	  <a href="<?php echo base_url(); ?>administrator/delete-web/<?php echo $val->web_item_id; ?>" onclick="return confirm('Are you sure delete this  ?')">Delete</a>	 </td>   
