...
<div style="float:right">  
  <a href="<?php echo base_url(); ?>administrator/addvideo" class="small-tile green-back">
  <img width="32" src="<?php echo base_url(); ?>assets_admin/images/icons/tick.png" class="hide-sm pull-right">
  <h3 class="h3-tile add_title">Add a new Video item</h3></a>	
</div>  
      <div class="warper container-fluid">     
	  <div class="page-header"><h1>Video item</h1></div>	
	  ...
	  <tr>       
	  <th>Section</th>     
     <?php /*?> <th>video name</th>	  <?php */?>
      <th>video download url</th>	  
      <?php /*?><th>video download start time</th>	  <?php */?>
	 ...
	 <?php /*?> <td><?php echo $val->	video_name; ?></td>		<?php */?>
	  <td><?php echo $val->video_download_url; ?></td>	
      <td><?php echo $val->downloadable; ?></td>

	 <?php /*?> <td><?php echo $val->video_download_start_time; ?></td>	<?php */?>	
 
	    
	  <td>		
	  <a class=""  href="<?php echo base_url().'administrator/edit-video/'.$val->video_item_id; ?>">Edit</a>	
	  <a class=""  href="<?php echo base_url().'administrator/viewvideo/'.$val->video_item_id; ?>">View</a>  
	<?php /*?>  <a class=""  href="<?php echo base_url().'administrator/disable-tournament/'.$val->id; ?>"><?php if($val->status == 1){echo 'Active';}else{echo 'deactive';} ?></a><?php */?>	
	  <a href="<?php echo base_url(); ?>administrator/delete-video/<?php echo $val->video_item_id; ?>" onclick="return confirm('Are you sure delete this  ?')">Delete</a>	 </td>   
