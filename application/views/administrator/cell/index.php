<?php include(dirname(__FILE__)."/../include/left_sidebar.php"); ?>
	<div style="float:right">  
	  <a href="<?php echo base_url(); ?>administrator/addcell" class="small-tile green-back">
	  <img width="32" src="<?php echo base_url(); ?>assets_admin/images/icons/tick.png" class="hide-sm pull-right">
	  <h3 class="h3-tile add_title"> Add Cell</h3>
	  </a>	
	</div>  
      <div class="warper container-fluid">     
	  <div class="page-header"><h1>Cell item</h1></div>	
  ...
  <?php /*?>    <th>Cell type</th>	<?php */?>
	  ...
	  <tr class="odd gradeX">   
	   ...
	   <td><?php echo $val->cell_item_id; ?></td>             
	 ...
	 <?php /*?> <td><?php echo $val->cell_blink_color; ?></td><?php */?>		
	  <td>		
	  <a class=""  href="<?php echo base_url().'administrator/edit-cell/'.$val->cell_item_id; ?>">Edit</a>	
	  <a class=""  href="<?php echo base_url().'administrator/viewcell/'.$val->cell_item_id; ?>">View</a>  
	<?php /*?>  <a class=""  href="<?php echo base_url().'administrator/disable-tournament/'.$val->id; ?>"><?php if($val->status == 1){echo 'Active';}else{echo 'deactive';} ?></a><?php */?>	
	  <a href="<?php echo base_url(); ?>administrator/delete-cell/<?php echo $val->cell_item_id; ?>" onclick="return confirm('Are you sure delete this  ?')">Delete</a>	 </td>   
